...
<body>
	...
	$("#replyAddBtn").on("click", function(){
		...
		// 폼이 없기 때문에, input태그 내에 입력된 요소를 가져와야 합니다.
		...
		$.ajax({
			...
			success : function(result) {
				if(result == 'SUCCESS'){
					...
					alert("등록 되었습니다.");
					getAllList(); // 댓글 등록 성공시, 다시 댓글 목록 갱신
					// 폼 태그 비우기.
					$("#newReplyWriter").val("");
					$("#newReplyText").val("");
				}

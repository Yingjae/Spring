...
public class BoardController {
	...
	// 메서드 내부에서는 boardMapper의 .getAllList를 호출해 그 결과를 바인딩 합니다.
	...
	// get방식으로 boardInsert 주소를 접속시 form 페이지로 연결 됩니다.
	...
	// /boardInsert인데 post방식을 처리하는 메서드를 새로 만들어 주세요.
	// boardVO를 입력받도록 해주시면 실제로는 boardVO의 멤버변수 명으로 들어오는 자료를 입력받습니다.
	// 입력받은 boardVO를 토대로 mapper의 insert 메서드를 실행해 주시고
	// 리다이렉트는 return"redirect:/목적지주소" 형식으로 리턴구문을 작성하면 됩니다.
	// boardList로 돌려보내주세요.
	@PostMapping(value="/boardInsert")
	public String baordForm(BoardVO board) {
	...
	// boardUpdateForm을 POST방식으로 접속하는 form연결 메서드를 만들겠습니다.

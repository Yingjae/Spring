...
public class PageMaker {
	...
	// Criteria에서 현재 조회중인 페이지 정보 + 한 페이지에 깔리는 글 수를 받아와야 함
	...
	public void calcData() {
		...
		// 위의 endPage는 명속상의(단순 그룹계산으로) 끝나는 페이지이기 때문에 실질적인 글 개수를 통해 보정 해줘야함
		...
		// next, prev 버튼 여부 처리
		// prev는 startPage가 1인 경우에만 비활성화 상태이므로 삼항연산자로 간단히 처리합니다.
